...
print("Starts with D:")
# Format: object.key for placeholder in array if object.key.conditional
...
# Specify tuple with (entry1, entry2). Must type array.element for both parts of If Statement.
...
# Must make call to Human object because we're changing every entry instead of sorting the information
